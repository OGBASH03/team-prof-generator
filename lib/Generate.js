// REQUIRES INQUIRER PATH AND EMPLOYEE FILES
...
//INITIALIZE GENERATE FUNCTION TO STORE EMPLOYEE DATA.
function Generate() {
    this.manager;
    this.engineer = [];
    this.intern = [];
...
//PROMPTS FOR SELECTING ADDITIONAL EMPLOYEES AND CONTINUING PROMPTS
Generate.prototype.initMainMenu = function() {
    ...
    .then(({menu}) => {
        ...
        //CALLS FUNCTION TO CREATE WEBPAGE WHEN ALL EMPLOYEES ARE OBTAINED
...
//FUNCTION CREATES DATA FOR EMPLOYEES AND RENDERS IN HTML
